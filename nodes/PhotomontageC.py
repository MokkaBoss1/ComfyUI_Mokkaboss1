...
class PhotomontageC:
    ...
    FUNCTION = "photomontage_c"
    CATEGORY = "👑 MokkaBoss1/Image"

    def photomontage_c(self, spacing, unit_width, unit_height, rec1_image1, rec1_image2, rec2_image3, rec2_image4,): 
        ...
        background_image2 = superimpose_images(background_image1, image2, int(2*spacing + unit_width), int(2*spacing + 1.5*unit_height))
        background_image3 = superimpose_images(background_image2, image3, spacing, int(2*spacing + unit_height))
        output_image = superimpose_images(background_image3, image4, (2*spacing + unit_width), (spacing))
...
NODE_CLASS_MAPPINGS = {"PhotomontageC": PhotomontageC}
NODE_DISPLAY_NAME_MAPPINGS = {"PhotomontageC": "👑 PhotomontageC"}